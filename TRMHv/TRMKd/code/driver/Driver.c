    ...
    PUNICODE_STRING RegistryPath)
{
    ...
    UNICODE_STRING DriverName    = RTL_CONSTANT_STRING(L"\\Device\\TRMHvDebuggerDevice");
    UNICODE_STRING DosDeviceName = RTL_CONSTANT_STRING(L"\\DosDevices\\TRMHvDebuggerDevice");
...
DrvUnload(PDRIVER_OBJECT DriverObject)
{
    ...
    RtlInitUnicodeString(&DosDeviceName, L"\\DosDevices\\TRMHvDebuggerDevice");
