...
SerialConnectionSendEndOfBuffer()
{
    ...
    // Send the end buffer
    //
    KdTRMHvSendByte(SERIAL_END_OF_BUFFER_CHAR_1, TRUE);
    KdTRMHvSendByte(SERIAL_END_OF_BUFFER_CHAR_2, TRUE);
    KdTRMHvSendByte(SERIAL_END_OF_BUFFER_CHAR_3, TRUE);
    KdTRMHvSendByte(SERIAL_END_OF_BUFFER_CHAR_4, TRUE);
}
...
SerialConnectionSendTwoBuffers(CHAR * Buffer1, UINT32 Length1, CHAR * Buffer2, UINT32 Length2)
{
    ...
    {
        KdTRMHvSendByte(Buffer1[i], TRUE);
    }
    ...
    {
        KdTRMHvSendByte(Buffer2[i], TRUE);
    }
                                 ...
                                 UINT32 Length3)
{
    ...
    {
        KdTRMHvSendByte(Buffer3[i], TRUE);
    }
...
SerialConnectionPrepare(PDEBUGGER_PREPARE_DEBUGGEE DebuggeeRequest)
{
    ...
    //
    KdTRMHvPrepareDebuggeeConnectionPort(DebuggeeRequest->PortAddress, DebuggeeRequest->Baudrate);
