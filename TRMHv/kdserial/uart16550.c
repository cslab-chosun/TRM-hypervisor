...
VOID
KdTRMHvPrepareDebuggeeConnectionPort(UINT32 PortAddress, UINT32 Baudrate)
{
...
VOID
KdTRMHvSendByte(UCHAR Byte, BOOLEAN BusyWait)
{
    Uart16550PutByte(&g_PortDetails, Byte, BusyWait);
}

BOOLEAN
KdTRMHvRecvByte(PUCHAR RecvByte)
{
