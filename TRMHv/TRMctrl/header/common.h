 ...
 * @brief header for TRMHv's general functions for reading and converting and
 * etc
 * @details
 * @version 0.1
 * @date 2020-05-27
...
#define ASSERT_MESSAGE_CANNOT_SPECIFY_PID "err, since TRMHv won't context-switch to keep the system in a halted state, "                       \
