 ...
 * @author Anonymized Author
 * @brief The TRMHv command interpreter and driver connector
 * @details
 * @version 0.1
 * @date 2020-04-11
 *
...
TRMHvIsConditionalJumpTaken(unsigned char * BufferToDisassemble,
                            UINT64          BuffLength,
                            RFLAGS          Rflags,
                            BOOLEAN         Isx86_64);

int
TRMHvDisassembler64(unsigned char * BufferToDisassemble,
                    UINT64          BaseAddress,
                    UINT64          Size,
...
int
TRMHvDisassembler32(unsigned char * BufferToDisassemble,
                    UINT64          BaseAddress,
                    UINT64          Size,
                    UINT32          MaximumInstrDecoded,
                    BOOLEAN         ShowBranchIsTakenOrNot,
...
UINT32
TRMHvLengthDisassemblerEngine(
    unsigned char * BufferToDisassemble,
    UINT64          BuffLength,
    BOOLEAN         Isx86_64);

BOOLEAN
TRMHvCheckWhetherTheCurrentInstructionIsCall(
    unsigned char * BufferToDisassemble,
    UINT64          BuffLength,
    BOOLEAN         Isx86_64,
    PUINT32         CallLength);
...
BOOLEAN
TRMHvCheckWhetherTheCurrentInstructionIsCallOrRet(
    unsigned char * BufferToDisassemble,
    UINT64          CurrentRip,
    UINT32          BuffLength,
    BOOLEAN         Isx86_64,
...
BOOLEAN
TRMHvCheckWhetherTheCurrentInstructionIsRet(
    unsigned char * BufferToDisassemble,
    UINT64          BuffLength,
    BOOLEAN         Isx86_64);

VOID
TRMHvReadMemoryAndDisassemble(DEBUGGER_SHOW_MEMORY_STYLE   Style,
                              UINT64                       Address,
