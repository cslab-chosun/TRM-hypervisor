 ...
 *
 */
BOOLEAN g_IsConnectedToTRMHvLocally = FALSE;
 ...
 * it is because in TRMHv, debuggee is server and debugger
 * is a client
 *
 */
 ...
 * it is because in TRMHv, debugger is client and debuggee
 * is a server
 *
 */
 ...
 *
 * @details this list is not have any relation with the things that TRMHv
...
/**
 * @brief Holds the location test-TRMHv.exe
 *
 */
