...
/**
 * @brief Convert TRMHv arguments for dt and struct commands to pdbex arguments
 ...
 */
BOOLEAN
CommandDtAndStructConvertTRMHvArgsToPdbex(vector<string> ExtraArgs,
    ...
    const char * AdditionalParameters)
{
    ...
    if (Address != NULL)
    {
        ...
        // Read the memory
        //
        TRMHvReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DT,
                                         Address,
    ...
    else
    {
                                                          ...
                                                          &TargetAddress))
        {
                                                              ...
                                                              &TargetAddress))
            {
                ...
                //
                if (!CommandDtAndStructConvertTRMHvArgsToPdbex(TempSplitCommand, PdbexArgs, &TargetPid))
                {
                    if (IsStruct)
                    {
                        CommandStructHelp();
