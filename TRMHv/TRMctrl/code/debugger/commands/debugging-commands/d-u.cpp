...
CommandReadMemoryAndDisassembler(vector<string> SplitCommand, string Command)
{
    ...
    {
        TRMHvReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DB,
                                         TargetAddress,
    ...
    {
        TRMHvReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DC,
                                         TargetAddress,
                                         DEBUGGER_READ_VIRTUAL_ADDRESS,
                                         READ_FROM_KERNEL,
                                         Pid,
    ...
    {
        TRMHvReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DD,
                                         TargetAddress,
                                         DEBUGGER_READ_VIRTUAL_ADDRESS,
                                         READ_FROM_KERNEL,
                                         Pid,
    ...
    {
        TRMHvReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DQ,
                                         TargetAddress,
                                         DEBUGGER_READ_VIRTUAL_ADDRESS,
                                         READ_FROM_KERNEL,
                                         Pid,
