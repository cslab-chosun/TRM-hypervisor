                      ...
                      ))
    {
        ...
        else if (LastError == ERROR_INVALID_IMAGE_HASH)
        {
            ShowMessages(
                ...
                "TRMHv is not compatible with Virtualization Based Security (VBS)\n"
                "please follow the instructions from: https://docs.TRMHv.org/getting-started/build-and-install \n");
