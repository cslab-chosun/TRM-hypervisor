...
StartAgain:
        ...
        case DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION_DEBUGGEE_PAUSED_AND_CURRENT_INSTRUCTION:
            ...
            if (!PausePacket->IgnoreDisassembling)
            {
                ...
                if (PausePacket->ReadInstructionLen != MAXIMUM_INSTR_SIZE)
                {
                    ...
                    //
                    if (TRMHvLengthDisassemblerEngine(PausePacket->InstructionBytesOnRip,
                                                         MAXIMUM_INSTR_SIZE,
                ...
                if (!PausePacket->IsProcessorOn32BitMode)
                {
                    ...
                    // Show diassembles
                    //
                    TRMHvDisassembler64(PausePacket->InstructionBytesOnRip,
                                           PausePacket->Rip,
                                           MAXIMUM_INSTR_SIZE,
                                           1,
                                           TRUE,
                ...
                else
                {
                    ...
                    // Show diassembles
                    //
                    TRMHvDisassembler32(PausePacket->InstructionBytesOnRip,
                                           PausePacket->Rip,
                                           MAXIMUM_INSTR_SIZE,
                                           1,
                                           TRUE,
        ...
        case DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION_DEBUGGEE_RESULT_OF_READING_MEMORY:
            ...
            if (ReadMemoryPacket->KernelStatus == DEBUGGER_OPERATION_WAS_SUCCESSFUL)
            {
                ...
                case DEBUGGER_SHOW_COMMAND_DISASSEMBLE64:
                    ...
                    // Show diassembles
                    //
                    TRMHvDisassembler64(MemoryBuffer, ReadMemoryPacket->Address, ReadMemoryPacket->ReturnLength, 0, FALSE, NULL);
                ...
                case DEBUGGER_SHOW_COMMAND_DISASSEMBLE32:
                    ...
                    // Show diassembles
                    //
                    TRMHvDisassembler32(MemoryBuffer, ReadMemoryPacket->Address, ReadMemoryPacket->ReturnLength, 0, FALSE, NULL);
            ...
            else
            {
                ...
                {
                    ShowMessages("TRMHv attempted to access an invalid target address: 0x%llx\n"
    ...
    {
        //
        // It's not a TRMHv packet, it's probably a GDB packet
        //
