 ...
 * @brief TRMHv general functions for reading and converting and etc
 * @details
 * @version 0.1
 * @date 2020-05-27
 *
...
CheckAccessValidityAndSafety(UINT64 TargetAddress, UINT32 Size)
{
    ...
    else
    {
        ...
        // TRMHv's script engine is not designed to be ran these functions in user-mode
