 ...
 */
VOID
TRMHvSetTextMessageCallback(Callback handler)
{
 ...
 */
int
TRMHvStopDriver(LPCTSTR DriverName)
{
    //
...
TRMHvStopVmmDriver()
{
    return TRMHvStopDriver(KERNEL_DEBUGGER_DRIVER_NAME);
}
 ...
 */
int
TRMHvUninstallDriver(LPCTSTR DriverName)
{
    //
 ...
 */
HPRDBGCTRL_API int
TRMHvUninstallVmmDriver()
{
    return TRMHvUninstallDriver(KERNEL_DEBUGGER_DRIVER_NAME);
}
...
TRMHvUnloadVmm()
{
    ...
    ShowMessages("you're not on TRMHv's hypervisor anymore!\n");
