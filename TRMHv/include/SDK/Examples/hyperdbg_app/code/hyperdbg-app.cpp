...
main()
{
    if (TRMHvLoadReversingMachine() == 0)
    {
        //
        // TRMHv driver loaded successfully
        //
        TRMHvUnloadReversingMachine();
    }
    else
    {
        ShowMessages("err, in loading TRMHv\n");
    }
}
