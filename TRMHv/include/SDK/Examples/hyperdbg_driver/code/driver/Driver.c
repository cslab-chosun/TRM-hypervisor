    ...
    PUNICODE_STRING RegistryPath)
{
    ...
    UNICODE_STRING DriverName    = RTL_CONSTANT_STRING(L"\\Device\\TRMHvReversingMachineDevice");
    UNICODE_STRING DosDeviceName = RTL_CONSTANT_STRING(L"\\DosDevices\\TRMHvReversingMachineDevice");
    ...
    if (Ntstatus == STATUS_SUCCESS)
    {
        ...
        //
        // We cannot use logging mechanism of TRMHv as it's not initialized yet
        //
    ...
    // We cannot use logging mechanism of TRMHv as it's not initialized yet
    //
    DbgPrint("TRMHv's device and major functions are loaded");
...
DrvUnload(PDRIVER_OBJECT DriverObject)
{
    ...
    RtlInitUnicodeString(&DosDeviceName, L"\\DosDevices\\TRMHvReversingMachineDevice");
