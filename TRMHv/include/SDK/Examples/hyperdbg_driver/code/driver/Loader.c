...
LoaderInitVmmAndReversingMachine()
{
    ...
    if (LogInitialize(&MsgTracingCallbacks))
    {
        ...
        {
            LogDebugInfo("TRMHv's hypervisor loaded successfully");
            ...
            {
                LogDebugInfo("TRMHv's reversing machine loaded successfully");
            ...
            {
                LogError("Err, TRMHv's debugger was not loaded");
            }
        }
        else
        {
            LogError("Err, TRMHv's hypervisor was not loaded");
        }
    }
    else
    {
        LogError("Err, TRMHv's message tracing module was not loaded");
    }
...
{
    LogDebugInfo("Unloading TRMHv's debugger...\n");
