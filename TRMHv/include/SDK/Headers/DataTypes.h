 ...
 * @brief TRMHv's SDK data type definitions
...
/**
 * @brief The structure of user-input packet in TRMHv
 *
 */
...
/**
 * @brief The structure of detail of a triggered event in TRMHv
...
/**
 * @brief The structure of pausing packet in kTRMHv
 *
 */
...
/**
 * @brief The structure of pausing packet in uTRMHv
 *
 */
...
/**
 * @brief The structure of message packet in TRMHv
 *
 */
