 ...
 * @brief TRMHv's SDK Headers For Native Structures, Enums and Constants
...
/**
 * @brief enum for requested action for TRMHv packet
 *
 */
...
/**
 * @brief enum for different packet types in TRMHv packets
 *
 */
...
/**
 * @brief The structure of remote packets in TRMHv
 *
 */
