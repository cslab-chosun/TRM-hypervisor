...
/**
 * @brief default port of TRMHv for listening by
 ...
 * debugging
 * @details it shows the maximum number of threads/processes that TRMHv sets
 * trap flag for them
 *
 */
...
#define INDICATOR_OF_TRMHv_PACKET \
    0x4859504552444247 // TRMHv = 0x4859504552444247
